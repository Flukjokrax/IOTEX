    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      <header className="space-y-4">
        ...
        <p className="text-lg text-gray-400 max-w-3xl leading-relaxed">
          This page allows you to configure some of the more important settings for your Delegate profile in the portal.
        </p>
      </header>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <p className="text-gray-400 text-sm leading-relaxed">
                  You'll be able to view and edit your Staking Bucket settings. Your bucket must maintain a minimum of 1.2M IOTX to remain eligible for consensus without external endorsement.
                </p>
          ...
          <div className="bg-[#14191f] border border-white/5 rounded-[2.5rem] p-10 shadow-2xl relative overflow-hidden group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2 space-y-6">
                <p className="text-gray-400 text-sm leading-relaxed">
                  As well as your Server Information and Reward Distribution settings. Update your node's networking metadata and define your reward policy to maintain transparency with your voters.
                </p>
